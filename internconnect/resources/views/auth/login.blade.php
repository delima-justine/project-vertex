    ...
    <main class="flex-grow flex items-center justify-center hero-gradient p-7">
        ...
        <div class="w-full max-w-md bg-white rounded-2xl card-shadow p-8 md:p-10">
            ...
            <form action="{{ route('login.post') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" 
                        class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-yellow-400 focus:ring-2 focus:ring-yellow-200 outline-none transition duration-200"
                ...
                <div class="flex items-center justify-between text-sm">
                    <label class="flex items-center text-gray-600 cursor-pointer">
                        <input type="checkbox" name="remember" class="w-4 h-4 text-yellow-500 border-gray-300 rounded focus:ring-yellow-400">
            ...
            <div class="mt-8 pt-6 border-t border-gray-100 text-center text-sm text-gray-500">
                <p>&copy; 2025 ROC.ph. Internal System.</p>
            </div>
